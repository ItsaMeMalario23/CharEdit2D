...
#define ASCII_MAX_2D_CHARS      ((u16) (ASCII_CHAR_BUF_SIZE / sizeof(ascii2_t)))
#define ASCII_MAX_3D_CHARS      ((u16) (ASCII_CHAR_BUF_SIZE / sizeof(ascii3_t)))
...
// Expose charbuf so char positions can be modified directly
extern ascii2_t* g_charbuf2D;
